...
![Release](https://img.shields.io/npm/v/@xdanangelxoqenpm/numquam-maxime-laborum)
![Downloads](https://img.shields.io/npm/dw/@xdanangelxoqenpm/numquam-maxime-laborum)
[![License](https://img.shields.io/:license-MIT-blue.svg?style=flat)](https://opensource.org/licenses/MIT)
[![CircleCI](https://img.shields.io/circleci/build/github/auth0/@xdanangelxoqenpm/numquam-maxime-laborum)](https://circleci.com/gh/auth0/@xdanangelxoqenpm/numquam-maxime-laborum)
...
In order to use `@xdanangelxoqenpm/numquam-maxime-laborum` in an environment that has no access to `atob()` (e.g. [React Native](https://github.com/facebook/hermes/issues/1178)), ensure to provide the corresponding polyfill in your application by using [`core-js/stable/atob`](https://www.npmjs.com/package/core-js):
...
To provide feedback or report a bug, please [raise an issue on our issue tracker](https://github.com/xdanangelxoqenpm/numquam-maxime-laborum/issues).
